...
![Diagrama de Arquitectura](/docs/Arquitectura%20Webhook.png)
...
![Diagrama de Secuencia CI/CD](/docs/ci-cd%20d%20secuencia.png)
...
![Panel de Grafana 1](/docs/paneles.png)
...
![Captura de Pyroscope](/docs/profiling.png)
### Profiling
